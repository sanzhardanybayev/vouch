...
describe('buildRecord', () => {
  ...
  it('does NOT supersede partially overlapping records', () => {
    ...
    const r = buildRecord({ ...BASE, kind: 'selection', range: [2, 4], existingCurrent: [partial] })
    expect(r.supersedes).toBeUndefined()
  })
